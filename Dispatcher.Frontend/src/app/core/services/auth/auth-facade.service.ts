...
export class AuthFacadeService {
  ...
  isDispatcher = computed(() => this._currentUser()?.role === UserRole.Dispatcher);
  isDriver = computed(() => this._currentUser()?.role === UserRole.Driver);
  isClient = computed(() => this._currentUser()?.role === UserRole.Client);
